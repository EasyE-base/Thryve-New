    ...
    try {
      ...
      const response = await openai.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "You are an expert data migration specialist for fitness studio management systems. Parse and structure fitness studio data into standardized formats."
          },
          {
            role: "user",
            content: prompt
